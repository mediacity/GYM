...
class PWAController extends Controller
{
    ...
    |--------------------------------------------------------------------------
    |
    | This controller is used to perform crud operations pwa.
     */
    /**
     * This function is used to display all pwa.
     *
     * @param $request
     * @return Renderable
     */
    ...
    /**
     * Update the specified pwa in storage.
     *
     * @param  \Illuminate\Http\Request  $request
     * @param  \App\Modules\Todo\Models\PWA  $pwa
    ...
    public function updatesetting(Request $request)
    {
        ...
        $env_keys_save = DotenvEditor::setKeys([
            'PWA_NAME' =>strip_tags( $request->app_name),
            'PWA_ENABLE' => isset($request->PWA_ENABLE) ? "1" : "0",
            'PWA_BG_COLOR' => strip_tags($request->PWA_BG_COLOR),
            'PWA_THEME_COLOR' => strip_tags($request->PWA_THEME_COLOR),
        ]);
        ...
        $destinationPath = public_path('image/icon');
