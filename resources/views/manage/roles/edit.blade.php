    ...
    <div class="col-md-12">
        ...
        <div class="card">
            <div class="card-header">
                ...
                <h5 class="card-title">{{ __('Edit Role: :role',['role' => $role->name]) }}</h5>
            ...
            <div class="card-body">
                <form action="{{ route('roles.update',$role->id) }}" method="POST" class="needs-validation" novalidate>
                    ...
                    <div class="form-group">
                        <label for="name" class="text-dark">{{ __("Role name ") }}<span class="text-danger">*</span></label>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <input @foreach($role->permissions as $rp)
                                            {{ $rp->id == $p['id'] ? "checked" : ""}} @endforeach class="permissioncheckbox"
                                            type="checkbox" id="customCheckboxInline{{ $p['id'] }}" value="{{ $p['name'] }}"
                                            name="permissions[]">
                                            <label
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @foreach($role_permission as $p)
                                            @if(strstr($p->name, 'paymentreport'))
                                            <input @foreach($role->permissions as $rp)
                                            {{ $rp->id == $p->id ? "checked" : ""}} @endforeach class="permissioncheckbox"
                                            type="checkbox" id="customCheckboxInline{{ $p['id'] }}" value="{{ $p['name'] }}"
                                            name="permissions[]">
                                            <label
                                                for="customCheckboxInline{{ $p['id'] }}">&nbsp;{{ str_replace('paymentreport.', '', $p['name']) }}</label>
                                            @endif
                                            @endforeach
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            name="permissions[]">
                                            <label
                                                for="customCheckboxInline{{ $p['id'] }}">&nbsp;{{ str_replace('service.', '', $p['name']) }}</label>
                    ...
                    <div class="form-group">
                        <button type="submit" class="btn btn-md btn-primary">
                            <i class="feather icon-save"></i> {{ __("Save") }}
                        </button>
