                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="form-group">
                                    ...
                                    @enderror
                                    <small class="text-muted text-info"> <i class="text-dark feather icon-help-circle"></i> {{ __("Choose the Measurement date") }}</small>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6">
                                <div class="form-group">
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="form-group">
                                    ...
                                    @enderror
                                    <small class="text-muted text-info"> <i
                                            class="text-dark feather icon-help-circle"></i>{{ __(" Enter abdomen Size") }}</small>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6">
                                <div class="form-group">
