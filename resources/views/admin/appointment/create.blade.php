                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="form-group{{ $errors->has('status') ? ' has-error' : '' }}">
                                    <label class=" text-dark" for="status">{{__("Choose a Select Status")}}<span class="text-danger" class="text-dark">*</span></label>
                                    <select data-placeholder="{{ __("Please select status") }}" class="form-control select2" name="appointment_status">
                            ...
                            <div class="col-lg-12 col-md-12">
                                <div class="form-group">
                                    <label class="text-dark" for="calendar">{{__("Appointment Date")}}<span class="text-danger">*</span></label>
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6">
