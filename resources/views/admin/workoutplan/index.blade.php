...
@section('title',__('All Workoutplan'))
@section('maincontent')
<!-- Start Breadcrumbbar -->
...
<div class="col-md-4 col-lg-4">
    <a href="{{route('workoutplan.create')}}" class="float-right btn btn-primary-rgba mr-2"><i
            class="feather icon-plus mr-2"></i>{{ __("Add Workoutplan") }}</a>
        ...
        <div class="card m-b-30">
            <div class="card-header">
                <div class="row align-items-center">
                    <div class="col-6">
                        <h5 class="card-title mb-0">{{ __("All Workoutplan") }}</h5>
                    </div>
                </div>
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <table id="datatable-buttons" class="table table-border">
                        ...
                        @if (isset($workoutplan))
                        <tbody>
                            @foreach($workoutplan as $key => $list)
                            <tr>
                                <td>
                                    <div class='inline'>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <form id="bulk_delete_form" method="post"
                                                        action="{{ route('workoutplan.bulk_delete') }}">
                                                        @csrf
                                                        @method('POST')
                                ...
                                <td>{{$list->note}}</td>
                                <td>
                                    {!! Form::open(['method' => 'PUT', 'route' => ['workoutplan.status', $list->id]])
                                    !!}
                                ...
                                <td>
                                    <div class="button-list">
                                        <a href="{{route('workoutplan.edit', $list->id)}}"
