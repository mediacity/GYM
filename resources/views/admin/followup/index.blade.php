...
@section('title',__('All Follow Up'))
@section('maincontent')
<!-- Start Breadcrumbbar -->                    
...
<div class="col-md-12 col-lg-6 text-right">
    <div class="top-btn-block ">
        <a href="{{route('followup.create')}}" class="btn btn-primary-rgba mr-2"><i class="feather icon-plus mr-2"></i>{{ __("Add Follow Up") }}</a>
        ...
        <div class="card m-b-30">
            <div class="card-header">
                <div class="row align-items-center">
                    <div class="col-6">
                        <h5 class="card-title mb-0">{{ __("All Follow Up") }}</h5>
                    </div>
                </div>
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <table id="datatable-buttons" class="table table-border">
                        ...
                        @if (isset($followlist))
                        <tbody>
                            @foreach($followlist as $key => $list)
                          <tr>
                                <td>
                            <div class='inline'>
                            ...
                            <div id="bulk_delete" class="delete-modal modal fade" role="dialog">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            <form id="bulk_delete_form" method="post"
                                                action="{{ route('followup.bulk_delete') }}">
                                                @csrf
                                                @method('POST')
                              ...
                              <td> {{($list->enquiry_name)}}</td>
                               <td>{{ucfirst($list->date)}} </td>
                                <td>{{str_limit($list->description,'50') }}</td>
                                ...
                                <td>
                                    <div class="button-list">
                                        <a href="{{route('followup.edit', $list->id)}}"
