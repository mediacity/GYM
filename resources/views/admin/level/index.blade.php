...
<div class="col-md-4 col-lg-4">
    <a href="{{route('level.create')}}" class="float-right btn btn-primary-rgba mr-2"><i
            class="feather icon-plus mr-2"></i>{{ __("Add Level") }}}</a>
        ...
        <div class="card m-b-30">
            <div class="card-header">
                <div class="row align-items-center">
                    <div class="col-6">
                        <h5 class="card-title mb-0">{{ __("All Level") }}</h5>
                    </div>
                </div>
            </div>
            <div class="card-body">
                    ...
                    <table id="datatable-buttons" class="table table-border">
                        ...
                        <tbody>
                            ...
                            <div id="bulk_delete" class="delete-modal modal fade" role="dialog">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            <form id="bulk_delete_form" method="post"
                                                action="{{ route('level.bulk_delete') }}">
                                                @csrf
                                                @method('POST')
                                ...
                                <td>{{$list->level}}</td>
                                <td>
                                    {!! Form::open(['method' => 'PUT', 'route' => ['level.status', $list->id]]) !!}
                                        ...
                                        <div id="deleteModal{{$list->id}}" class="delete-modal modal fade"
                                            ...
                                            <div class="modal-dialog modal-sm">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        {!! Form::open(['method' => 'DELETE', 'route' => ['level.destroy',$list->id]]) !!}
