...
<div class="col-md-12 col-lg-6 text-right">
    <div class="top-btn-block">
        <a href="{{route('group.create')}}" class="btn btn-primary-rgba mr-2"><i
            class="feather icon-plus mr-2"></i>{{ __("Add Group") }}</a>
            ...
            <div class="card m-b-30">
                <div class="card-header">
                    <div class="row align-items-center">
                        <div class="col-6">
                            <h5 class="card-title mb-0">{{ __("All Group") }}</h5>
                        </div>
                    ...
                    <div class="table-responsive">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            <form id="bulk_delete_form" method="post"
                                                action="{{ route('group.bulk_delete') }}">
                                                @csrf
                                                @method('POST')
                        ...
                        <td>
                                    ...
                                    <td>
                                        ...
                                        @endphp
                                        @if(isset($user))
                                        <span class="badge badge-primary">{{ ucfirst($user->name) }}</span>
                                        @endif
                                        @endforeach
                                        @endisset
                                    </td>
                                    <td>
                                        {!! Form::open(['method' => 'PUT', 'route' => ['group.status', $list->id]]) !!}
                                    ...
                                    <td>
                                        <div class="button-list">
                                            <a href="{{route('group.edit', $list->id)}}"
