...
@section('title',__('All SecondLanguage'))
@section('maincontent')
<!-- Start Breadcrumbbar -->
...
<div class="col-md-6 col-lg-6">
    <a href="{{route('secondlanguage.create')}}" class="float-right btn btn-primary-rgba mr-2"><i
            class="feather icon-plus mr-2"></i>{{ __("Add SecondLanguage") }}</a>
        ...
        <div class="card m-b-30">
            <div class="card-header">
                <div class="row align-items-center">
                    <div class="col-6">
                        <h5 class="card-title mb-0">{{ __("All SecondLanguage") }}</h5>
                    </div>
                </div>
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <table id="datatable-buttons" class="table table-border">
                        ...
                        <tbody>
                            @foreach($secondlanguage as $key => $list)
                            <tr>
                                <td>
                                    <div class='inline'>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <form id="bulk_delete_form" method="post"
                                                        action="{{ route('secondlanguage.bulk_delete') }}">
                                                        @csrf
                                                        @method('POST')
                                ...
                                <td>{{$list->secondlanguage}}</td>
                                <td>
                                    {!! Form::open(['method' => 'PUT', 'route' => ['secondlanguage.status', $list->id]])
                                    !!}
                                ...
                                <td>
                                    <div class="button-list">
                                        <a href="{{route('secondlanguage.edit', $list->id)}}"
                                            ...
                                            <div class="modal-dialog modal-sm">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        ['secondlanguage.destroy',$list->id]]) !!}
