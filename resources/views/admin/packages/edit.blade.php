                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6">
                        <div class="form-group{{ $errors->has('title') ? ' has-error' : '' }}">
                            ...
                            <small class="text-muted text-info"> <i class="text-dark feather icon-help-circle"></i> {{ __("Add a Package Title : Gold Bronze Card, Special Card..") }}</small>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6">
                        <div class="form-group{{ $errors->has('duration') ? ' has-error' : '' }}">
                            ...
                            <small class="text-muted text-info"> <i class="text-dark feather icon-help-circle"></i>{{ __(" Enter the Package Duration For eg: 12 Months, 6Months") }}</small>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6">
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="form-group{{ $errors->has('offerprice') ? ' has-error' : '' }}">
                            ...
                            <small class="text-muted text-info"> <i class="text-dark feather icon-help-circle"></i>{{ __(" Enter thePackage Offerprice For eg: 1800 ,2000...") }}</small>
                        </div>
                    </div>
