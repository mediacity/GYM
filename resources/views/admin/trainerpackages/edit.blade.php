...
@section('title',__('Edit Trainerpackages :eid -',['eid' => $trainerpackages->name]))
@section('maincontent')
<!-- Start Breadcrumbbar -->                    
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="admin-form">
                            {!! Form::model($trainerpackages, ['method' => 'PATCH', 'route' => ['trainerpackages.update',
                            $trainerpackages->id], 'files' => true ,'class' => 'form form-light' ,'novalidate']) !!}
                               <div class="form-group{{ $errors->has('trainer id') ? ' has-error' : '' }}">
                                ...
                                <select data-placeholder="{{ __("Please select group" ) }}class="form-control select2"
                                    ...
                                    <option {{ $trainerpackages['trainer_name'] == $trainer ->id ? "selected" : "" }}
                            ...
                            <div class="form-group{{ $errors->has('duration') ? ' has-error' : '' }}">
                                {!! Form::label('duration', 'Package Duration',['class'=>'required']) !!} <span
                                    class="text-danger">*</span>
                                {!! Form::text('duration', null, ['class' => 'form-control', 'required','placeholder' =>
                                'Please Enter Package Duration']) !!}
                                <small class="text-danger">{{ $errors->first('duration') }}</small>
                                <small class="text-muted"> <i class="text-dark feather icon-help-circle"></i> {{ __("Add a Package Duration: 12 Months,6Months") }}</small>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                        ...
                        <div class="form-group{{ $errors->has('stripe_id') ? ' has-error' : '' }}">
                            ...
                            <div
                                ...
                                <div class="custom-switch">
                                    {!! Form::checkbox('is_active', 1,$trainerpackages->is_active==1 ? 1 : 0, ['id' =>
