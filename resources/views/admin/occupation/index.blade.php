...
@section('title',__('All Occupation'))
@section('maincontent')
<!-- Start Breadcrumbbar -->
...
<div class="col-md-4 col-lg-4">
    <a href="{{route('occupation.create')}}" class="float-right btn btn-primary-rgba mr-2"><i
            class="feather icon-plus mr-2"></i>{{ __("Add Occupation") }}</a>
        ...
        <div class="card m-b-30">
            <div class="card-header">
                <div class="row align-items-center">
                    <div class="col-6">
                        <h5 class="card-title mb-0">{{ __("All Occupation") }}</h5>
                    </div>
                </div>
            </div>
            <div class="card-body">
                    ...
                    <table id="datatable-buttons" class="table table-border">
                        ...
                        <tbody>
                            ...
                            <tr>
                                        ...
                                        <div class="modal-dialog modal-sm">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body text-center">
                                                    ...
                                                    <p>{{ __("Do you really want to delete selected item names here? The process cannot be undone.") }}</p>
                                                </div>
                                                <div class="modal-footer">
                                                    <form id="bulk_delete_form" method="post"
                                                        action="{{ route('occupation.bulk_delete') }}">
                                                        @csrf
                                                        @method('POST')
                                ...
                                <td>
                                    {!! Form::open(['method' => 'PUT', 'route' => ['occupation.status', $list->id]]) !!}
                                ...
                                <td>
                                    <div class="button-list">
                                        <a href="{{route('occupation.edit', $list->id)}}"
