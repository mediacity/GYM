...
@section('title',__('Edit Occupation :eid -',['eid' => $occupation->occupation]))
@section('maincontent')
<!-- Start Breadcrumbbar -->                    
        ...
        <div class="card m-b-30">
            <div class="card-header">
                <div class="row align-items-center">
                    <div class="col-12">
                        <h5 class="card-title mb-0">{{ __("Edit occupation") }}</h5>
                    </div>
                </div>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12">
                        <div class="admin-form">
                            {!! Form::model($occupation, ['method' => 'PATCH', 'route' => ['occupation.update', $occupation->id], 'files' =>
                            ...
                            <div class="form-group{{ $errors->has('is_active') ? ' has-error' : '' }} switch-main-block">
                                <div class="custom-switch">
                                    {!! Form::checkbox('is_active', 1,$occupation->is_active==1 ? 1 : 0, ['id' => 'switch1',
