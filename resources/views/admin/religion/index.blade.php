...
<div class="col-md-4 col-lg-4">
    <a href="{{route('religion.create')}}" class="float-right btn btn-primary-rgba mr-2"><i
            class="feather icon-plus mr-2"></i>{{ __("Add Religion") }}</a>
        ...
        <div class="card m-b-30">
            <div class="card-header">
                <div class="row align-items-center">
                    <div class="col-6">
                        <h5 class="card-title mb-0">{{ __("All Religion") }}</h5>
                    </div>
                </div>
            </div>
            <div class="card-body">
                    ...
                    <table id="datatable-buttons" class="table table-border">
                        ...
                        <tbody>
                            ...
                            <tr>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <form id="bulk_delete_form" method="post"
                                                        action="{{ route('religion.bulk_delete') }}">
                                                        @csrf
                                                        @method('POST')
                                ...
                                <td>{{$list->religion}}</td>
                                <td>
                                    {!! Form::open(['method' => 'PUT', 'route' => ['religion.status', $list->id]]) !!}
                                ...
                                <td>
                                    <div class="button-list">
                                        <a href="{{route('religion.edit', $list->id)}}"
                                        ...
                                        <div id="deleteModal{{$list->id}}" class="delete-modal modal fade"
                                            ...
                                            <div class="modal-dialog modal-sm">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body text-center">
                                                        <h4 class="modal-heading">{{ __("Are You Sure ?") }}</h4>
                                                        <p>{{ __("Do you really want to delete these records? This processcannot be undone.") }}</p>
                                                    </div>
                                                    <div class="modal-footer">
