                ...
                <div class="card m-b-3">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-10 col-9">
                                    <label class="text-dark">{{ __("SecondLanguage:") }} <span
                                            class="text-danger">*</span></label>
                        ...
                        <div class="form-group">
                            <label class="text-dark" for="address">{{ __("Description: ") }}<span
                                    class="text-danger">*</span></label>
                            <textarea required="" class="@error('description') is-invalid @enderror form-control"
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="admin-form">
                                ...
                                {!! Form::text('religion', null, ['class' => 'form-control', 'required','placeholder' =>
