            ...
            <div class="row">
              <div class="col-lg-6 col-md-6">
                <div class="form-group">
                  ...
                  <input value="{{ $enquiry->name }}" type="text" class="form-control mb-2  @error('name') is-invalid @enderror"
                  ...
                  @enderror
                  <small class="text-muted text-info text-info"> <i class="text-dark feather icon-help-circle"></i> {{ __("Enter your name..") }}</small>
                </div>
                <div class="form-group">
                  <label class="text-dark">{{ __("Age:") }} <span class="text-danger">*</span></label>
                  <input value="{{ $enquiry->age }}" type="text" class="form-control mb-2  @error('age') is-invalid @enderror"
                  ...
                  @enderror
                  <small class="text-muted text-info text-info"> <i class="text-dark feather icon-help-circle"></i> {{ __("Enter your Age..") }}</small>
                </div>
                <div class="form-group">
                  ...
                  <input value="{{ $enquiry->mobile }}" type="text" pattern="[0-9]{10}"
                    class="form-control mb-2  @error('mobile') is-invalid @enderror" placeholder="{{ __("Your current Mobile Number") }}"
                  ...
                  @enderror
                  <small class="text-muted text-info"> <i class="text-dark feather icon-help-circle"></i>{{ __(" Enter your mobile number") }}</small>
                </div>
              </div>
              <div class="col-lg-6 col-md-6">
                <div class="form-group">
                  ...
                  <input value="{{ $enquiry->f_name }}" type="text"
                    class="form-control mb-2  @error('f_name') is-invalid @enderror" placeholder="{{ __('"Your Fathers Name"') }}"
                  ...
                  @enderror
                  <small class="text-muted text-info"> <i class="text-dark feather icon-help-circle"></i>{{ __(" Enter your father name..") }}</small>
                </div>
                <div class="form-group">
                  <label class="text-dark">{{ __("Email: ") }}<span class="text-danger">*</span></label>
                  <input value="{{ $enquiry->email }}" type="email"
                    class="form-control mb-2  @error('email') is-invalid @enderror" placeholder="{{ __("Your Email") }}" name="email"
                    required="">
                  @error('email')
                  <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                  ...
                  @enderror
                  <small class="text-muted text-info"> <i class="text-dark feather icon-help-circle"></i>{{ __(" Enter your valid email") }}</small>
                </div>
                <div class="form-group">
                  <label class="text-dark">{{ __("Alternate Mobile Number:") }}
                  </label>
                  <input value="{{ $enquiry->phone }}" type="text" class="form-control mb-2 "
                  ...
                  @enderror
                  <small class="text-muted text-info"> <i class="text-dark feather icon-help-circle"></i>{{ __(" Enter your alternate mobile number") }}</small>
                </div>
              </div>
              <div class="col-lg-12 col-md-12">
                <div class="form-group">
                  <label class="text-dark" for="address">{{ __("Description:") }} <span class="text-danger">*</span></label>
                  <textarea required="" class="@error('description') is-invalid @enderror form-control mb-2 " id="description"
              ...
              <div class="col-lg-6 col-md-6">
                ...
                <div class="form-group">
                  ...
                  <input value="{{ $enquiry->pincode }}" type="text" pattern="[0-9]{6}"
                    class="form-control mb-2  @error('pincode') is-invalid @enderror" placeholder="{{ __("Your city Pincode") }}"
                  ...
                  @enderror
                  <small class="text-muted text-info"> <i class="text-dark feather icon-help-circle"></i> {{ __("Enter your city pincode") }}</small>
                </div>
              </div>
              <div class="col-lg-12 col-md-12">
                <div class="form-group">
            ...
            <div class="row">
              <div class="col-lg-6 col-md-6">
                <div class="form-group">
                  ...
                  @enderror
                  <small class="text-muted text-info" name="type"> <i class="text-dark feather icon-help-circle"></i> {{ __("Select your Enquiry Purpose") }}
                  </small>
                </div>
                <div class="form-group">
                  ...
                  @enderror
                  <small class="text-muted text-info"> <i class="text-dark feather icon-help-circle"></i> {{ __("Select cost eg:10,000, 12,000") }} </small>
                </div>
                <div class="form-group">
                  ...
                  @enderror
                  <small class="text-muted text-info"> <i class="text-dark feather icon-help-circle"></i> {{ __("Select religion eg:buddhism,islam ") }}</small>
                </div>
                <div class="form-group">
                  <label class="text-dark">{{ __("Second Language: ") }}<span class="text-danger">*</span></label>
                  ...
                  @enderror
                  <small class="text-muted text-info"> <i class="text-dark feather icon-help-circle"></i>{{ __(" Select occupation eg:marathi,gujrathi") }} </small>
                </div>
              </div>
              <div class="col-lg-6 col-md-6">
                <div class="form-group">
                  ...
                  @enderror
                  <small class="text-muted text-info" name="details"> <i class="text-dark feather icon-help-circle"></i> {{ __("Select where you get details") }}
                  </small>
                </div>
                ...
                <div class="form-group">
                  ...
                  @enderror
                  <small class="text-muted text-info"> <i class="text-dark feather icon-help-circle"></i> {{ __("Select occupation eg:dentist,bussinessman") }} </small>
                </div>
                <div class="form-group">
                  ...
                  @enderror
                  <small class="text-muted text-info" name="details"> <i class="text-dark feather icon-help-circle"></i>{{ __(" Enter your health description:For eg.- any health problem like B.P, Sugar etc..") }}
                  </small>
                </div>
              </div>
            </div>
