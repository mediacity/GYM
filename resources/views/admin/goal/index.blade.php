...
<div class="col-md-4 col-lg-4">
    <a href="{{route('goal.create')}}" class="float-right btn btn-primary-rgba mr-2"><i
            class="feather icon-plus mr-2"></i>{{ __("Add Goal") }}</a>
        ...
        <div class="card m-b-30">
            <div class="card-header">
                <div class="row align-items-center">
                    <div class="col-6">
                        <h5 class="card-title mb-0">{{ __("All Goal") }}</h5>
                    </div>
                </div>
            </div>
            <div class="card-body">
                    ...
                    <table id="datatable-buttons" class="table table-border">
                        ...
                        <tbody>
                            ...
                            <div id="bulk_delete" class="delete-modal modal fade" role="dialog">
                                ...
                                <td>{{$list->goal}}</td>
                                <td>
                                    {!! Form::open(['method' => 'PUT', 'route' => ['goal.status', $list->id]]) !!}
                                ...
                                <td>
                                    <div class="button-list">
                                        <a href="{{route('goal.edit', $list->id)}}"
                                        ...
                                        <div id="deleteModal{{$list->id}}" class="delete-modal modal fade"
                                            ...
                                            <div class="modal-dialog modal-sm">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        {!! Form::open(['method' => 'DELETE', 'route' => ['goal.destroy',$list->id]]) !!}
