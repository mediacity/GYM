        ...
        <div class="card m-b-30">
            <div class="card-header">
                <div class="row align-items-center">
                    <div class="col-6">
                        <h5 class="card-title mb-0">{{ __("Create Locker") }}</h5>
                    </div>
                </div>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12">
                        <div class="admin-form">
                            {!! Form::open(['method' => 'POST', 'route' => 'locker.store','files' => true , 'class' =>
                            ...
                            <div class="text-dark" class="form-group{{ $errors->has('lockerno') ? ' has-error' : '' }}">
                                {!! Form::label('lockerno', 'Lockerno',['class'=>'required']) !!}<span
                                ...
                                <small class="text-muted text-info"> <i class="text-dark feather icon-help-circle"></i>
                                   {{ __(" Add a Unique Locker :98765566") }}</small>
                            </div>
                            <br>
                            <div class="form-group">
                                <label class="text-dark" for="calendar">{{ ("Date") }}<span class="text-danger">*</span></label>
                                <div class="col-md-12">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <label class="text-dark" for="calendar">{{ __("Locker Assigned") }}</label>
