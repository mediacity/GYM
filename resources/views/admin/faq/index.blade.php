...
<div class="col-md-6 col-lg-6 text-right">
    <a href="{{route('faq.create')}}" class="btn btn-primary-rgba mr-2"><i
            class="feather icon-plus mr-2"></i>{{ __("Add Faq") }}</a>
    ...
    <a href="{{ route('faqs.index') }}" class="btn btn-success-rgba mr-2"><i
        ...
        <div class="card m-b-30">
            <div class="card-header">
                <div class="row align-items-center">
                    <div class="col-6">
                        <h5 class="card-title mb-0">{{ __("All Faq") }}</h5>
                    </div>
                </div>
            </div>
            <div class="card-body">
                    ...
                    <table id="datatable-buttons" class="table table-border">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{str_limit($list->title,'10') }}</td>
                                <td>{!!substr(strip_tags($list->details), 0, 30) !!}...</td>
                                <td>
                                    {!! Form::open(['method' => 'POST', 'route' => ['faq.status', $list->id]]) !!}
                                    <div class="custom-switch">
                                        {!! Form::checkbox('status', 1, $list->status == 1 ? 1 : 0, ['id' =>
