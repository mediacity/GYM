...
<div class="col-md-4 col-lg-4">
    <a href="{{route('cost.create')}}" class="float-right btn btn-primary-rgba mr-2"><i
            class="feather icon-plus mr-2"></i>{{ __('Add Cost') }}</a>
        ...
        <div class="card m-b-30">
            <div class="card-header">
                <div class="row align-items-center">
                    <div class="col-6">
                        <h5 class="card-title mb-0">{{ __('All Cost') }}</h5>
                    </div>
                </div>
            </div>
            <div class="card-body">
                    ...
                    <table id="datatable-buttons" class="table table-border">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$list->cost}}</td>
                                <td>
                                    {!! Form::open(['method' => 'PUT', 'route' => ['cost.status', $list->id]]) !!}
                                ...
                                <td>
                                    <div class="button-list">
                                        <a href="{{route('cost.edit', $list->id)}}"
