      <div class="admin-table-action-block">
              <!-- Delete Modal -->
                          <button type="button" class="btn btn-xm btn-danger-rgba" data-toggle="modal" data-target="#deleteModal{{$id}}"><i class="feather icon-trash"></i></button>
                          <!-- Modal -->
                            ...
                            <div class="modal-dialog modal-sm">
                              ...
                              <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                   {!! Form::open(['method' => 'DELETE', 'route' => ['multicurrency.destroy', $id]]) !!}
