...
<?php $__env->startSection('title',__('Edit Staff Attendance :eid -',['eid' => $staffattendance->id])); ?>
    ...
    <div class="row align-items-center">
            ...
            <div class="breadcrumb-list">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">
                        <?php echo e(__('Edit Staff Attendance')); ?>
        ...
        <div class="col-lg-8 col-md-4">
            <div class="top-btn-block text-right">
                <a href="<?php echo e(route('memberattendance.index')); ?>" title="Go To Member Attendance" role="button"
                    class="btn btn-info-rgba mr-2">
                    <?php echo e(__("Member Aattendance")); ?><i class="feather icon-arrow-left ml-2"></i></a>
                <a href="<?php echo e(route('staffattendance.index')); ?>" class="btn btn-primary-rgba mr-2"><i
                class="feather icon-arrow-right mr-2"></i><?php echo e(__("Back")); ?></a>
...
<form autocomplete="off" class="form-light form" novalidate
    action="<?php echo e(route('staffattendance.update', $staffattendance->id)); ?>" method="POST">
...
unset($__errorArgs, $__bag); ?> form-control select2">
                                    ...
                                    <option <?php echo e($staffattendance['user_id'] == $user->id ? "selected" : ""); ?>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input value="<?php echo e($staffattendance->date); ?>" name="date" type="text" id="calendar"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="form-group">
                                <label class="text-dark"><?php echo e(__("Comments:")); ?> <span
                                        class="text-danger">*</span></label>
                                <input value="<?php echo e($staffattendance->comment); ?>" autofocus="" type="text"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="form-group<?php echo e($errors->has('location') ? ' has-error' : ''); ?>">
                                ...
                                <?php echo Form::textarea('location', $staffattendance->location, ['id' => 'location','class'
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="form-group member-attendance-slider">
                                <label class="text-dark"><?php echo e(__("Attendance: ")); ?><span
                                        class="text-danger">*</span></label><br>
                                <label class="switch"><input type="checkbox" id="togBtn" name="attend"
                                        <?php echo e($staffattendance->attend == 'present' ? 'checked' : ''); ?>>
                                    <div class="slider round">
                                        <!--ADDED HTML -->
                                        <span class="on"><?php echo e(__("Present")); ?></span><span
                                            class="off"><?php echo e(__("Absent")); ?></span>
                                        <!--END-->
                                    </div>
                                </label>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\GYM\resources\views/admin/staffattendance/edit.blade.php ENDPATH**/ ?>