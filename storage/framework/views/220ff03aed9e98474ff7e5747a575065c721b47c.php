                                ...
                                <div class="row">
                                    <div class="form-group health-form">
                                        <select data-placeholder="<?php echo e(__('Please select if you have any issue')); ?>"
                                            name="issue[]" class="mdb-select md-form form-control select2"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-10 col-9">
                                    <label class="text-dark"><?php echo e(__("SecondLanguage:")); ?> <span
                                            class="text-danger">*</span></label>

                                    <select autofocus="" class="form-control select2" name="second_language">
                                        <option value=""><?php echo e(__("Select SecondLanguage")); ?></option>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group<?php echo e($errors->has('status') ? ' has-error' : ''); ?>">
                            ...
                            <select data-placeholder="<?php echo e(__("Please select status")); ?>" class="form-control select2" name="status">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="admin-form">
                                ...
                                <?php echo Form::text('religion', null, ['class' => 'form-control', 'required','placeholder' =>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="admin-form">
                                ...
                                <?php echo Form::label('occupation', 'Occupation',['class'=>'required']); ?><span
                                    class="text-danger">*</span>
                                <?php echo Form::text('occupation', null, ['class' => 'form-control', 'required','placeholder'
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="admin-form">
                                ...
                                <?php echo Form::label('secondlanguage', 'SecondLanguage',['class'=>'required']); ?><span
                                    class="text-danger">*</span>
                                <?php echo Form::text('secondlanguage', null, ['class' => 'form-control',
...
<!-- End Modal -->
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\GYM\gym_new\resources\views/admin/enquiry/create.blade.php ENDPATH**/ ?>