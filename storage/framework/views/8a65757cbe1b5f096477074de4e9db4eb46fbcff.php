                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    <label for="link_by"><?php echo e(__("Link BY:")); ?></label>
                                                    <select class="form-control select2" name="link_by" id="link_by">
                                                        <option value="none"><?php echo e(__("None")); ?></option>
                                                        <option value="url"><?php echo e(__("URL")); ?></option>
                                                        <option value="channel"><?php echo e(__("Channel")); ?></option>
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            ...
                                                            <input name="buttonname" type="text" value=""
                                                                placeholder="<?php echo e(__("Enter Button Text")); ?>" class="form-control" />
                                                        </div>
                                                        <div class="col-md-4">
                                                            <label for=""><?php echo e(__("Button Text Color:")); ?></label>
                                                            <input class="form-control" type="color" value=""
                                                                name="btntextcolor">
                                                        </div>
                                                        <div class="col-md-4">
                                                            <label for=""><?php echo e(__("Button Background Color:")); ?></label>
                                                            <input class="form-control" type="color" value=""
                                                                name="btnbgcolor">
                                                        </div>
                                                    </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\gym_new\resources\views/admin/slider/create.blade.php ENDPATH**/ ?>