                    ...
                    <div class="col-md-12">
                        <div class="admin-form">
                            ...
                            <div class="form-group<?php echo e($errors->has('slug') ? ' has-error' : ''); ?>">
                                ...
                                <small class="text-muted"> <i class="text-dark feather icon-help-circle"></i> <?php echo e(__("Add a Slug")); ?></small>
                            </div>
                            <div
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\GYM\gym_new\resources\views/admin/fees/edit.blade.php ENDPATH**/ ?>