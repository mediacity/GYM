...
unset($__errorArgs, $__bag); ?>" value="">
                            ...
                            <small class="text-muted text-info"> <i class="text-dark feather icon-help-circle"></i> <?php echo e(__("Enter the content and its calories which your diet need eg : Rice:130 kcal, Tomato:22 kcal")); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\GYM\resources\views/admin/diet/edit.blade.php ENDPATH**/ ?>