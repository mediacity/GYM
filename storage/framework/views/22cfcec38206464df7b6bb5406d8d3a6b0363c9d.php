    ...
    <div class="row align-items-center">
        ...
        <div class="col-lg-8 col-md-7">
            <div class="top-btn-block text-right">
              ...
              <a href="<?php echo e(route('pack.index')); ?>" class="btn btn-success-rgba mr-2"><i class="feather icon-download-cloud mr-2"></i><?php echo e(__("Recycle")); ?></a>
            </div>
        </div>
        <?php endif; ?>
    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\GYM\resources\views/admin/packages/index.blade.php ENDPATH**/ ?>