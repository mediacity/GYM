                    ...
                    <div class="col-md-12">
                        <div class="admin-form">
                            ...
                            <div class="form-group<?php echo e($errors->has('name') ? ' has-error' : ''); ?>">
                                ...
                                <small class="text-muted text-info"> <i class="text-dark feather icon-help-circle"></i> <?php echo e(("Enter the exercise  Type : Traditional pushup , Clap Pushup")); ?>}}</small>
                            </div>
                            <div
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\GYM\resources\views/admin/type/create.blade.php ENDPATH**/ ?>