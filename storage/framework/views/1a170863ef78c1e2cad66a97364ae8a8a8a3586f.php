...
<?php $__env->startSection('title', __('Add Blog Category')); ?>
                ...
                <div class="breadcrumb-list">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">
                        	<?php echo e(__('Add Blog Category')); ?>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="admin-form">
                                <?php echo Form::open(['method' => 'POST', 'route' => 'blogcategory.store', 'files' => true, 'class' => 'form form-light' ,'novalidate']); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\GYM\resources\views/admin/blog/blogcategory/create.blade.php ENDPATH**/ ?>