...
<?php $__env->startSection('title',__('Add Diet')); ?>
...
<form class="form form-light" action="<?php echo e(route('diet.store')); ?>" method="POST" novalidate novalidate enctype="multipart/form-data">
        ...
        <div class="col-md-12">
            <div class="card">
                 <div class="card-header">
                    <h1 class="card-title"><?php echo e(__('Add a new diet:')); ?></h1>
                </div>
                <br>
                <div class="col-md-12">
                    <div class="row">
                        <div class="col-lg-6 col-md-6">
                            <div class="form-group">
                                ...
                                <input pattern="\A\pL+\z" value="<?php echo e(old('dietname')); ?>" autofocus="" type="text"
                                    class="form-control <?php $__errorArgs = ['dietname'];
...
unset($__errorArgs, $__bag); ?>
                                <small class="text-muted text-info"> <i class="text-dark feather icon-help-circle"></i> <?php echo e(__("Enter your diet type eg : Weight Loss, Body Shaping")); ?> </small>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6">
                            <div class="form-group">
                                ...
                                <select data-placeholder="<?php echo e(__('Please select day')); ?>" name="day_id[]"
                                    class="mdb-select md-form form-control select2  <?php $__errorArgs = ['day_id[]'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                <small class="text-muted text-info"> <i class="text-dark feather icon-help-circle"></i> <?php echo e(__("Enter the day on which you have to eat the diet eg : Monday, Tuesday")); ?> </small>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6">
                            <div class="form-group">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="form-group<?php echo e($errors->has('description') ? ' has-error' : ''); ?>">
                                <?php echo Form::label('description', 'Description',['class'=>'required text-dark']); ?> <span
                                    class="text-danger">*</span>
                                <?php echo Form::textarea('description',null, ['id' => 'description','class' =>
                                'form-control ' ,'required','placeholder' => 'Your Diet Description']); ?>

                                <small class="text-danger"><?php echo e($errors->first('description')); ?></small>
                                <small class="text-muted text-info"> <i class="text-dark feather icon-help-circle"></i><?php echo e(__(" Describe your diet to eat eg : Rice ,Salad ")); ?></small>
                            </div>
                        </div>
                                    ...
                                    <tbody>
                                        <tr id="tableBody" class="tbody">
                                            <td><input type="text" name="content[]"
                                                    class="diet_content form-control <?php $__errorArgs = ['content'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                            ...
                                            <td><input type="number" min="1" name="single_kal[]"
                                                    class="form-control single_kal  <?php $__errorArgs = ['single_kal'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                            ...
                                            <td><input type="text" name="dcalories[]"
                                                    class="form-control dcalories <?php $__errorArgs = ['dcalories'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                            ...
                            <small class="text-muted text-info"> <i class="text-dark feather icon-help-circle"></i> <?php echo e(__("Enter the content , quantity and its calories which your diet need eg : Rice:130 kcal, Tomato:22 kcal")); ?>
...
unset($__errorArgs, $__bag); ?>
                        <div class="col-lg-6 col-md-6">
                            <div class="form-group<?php echo e($errors->has('image') ? ' has-error' : ''); ?> input-file-block">
                                <?php echo Form::label('image', 'Diet Image',['class'=>'text-dark']); ?> </br>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\GYM\resources\views/admin/diet/create.blade.php ENDPATH**/ ?>