...
unset($__errorArgs, $__bag); ?>
                                    <small class="text-muted text-info"> <i class="text-dark feather icon-help-circle"></i> <?php echo e(__("Choose the Measurement date")); ?></small>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6">
                                <div class="form-group">
...
unset($__errorArgs, $__bag); ?>
                                    <small class="text-muted text-info"> <i
                                            class="text-dark feather icon-help-circle"></i><?php echo e(__(" Enter abdomen Size")); ?></small>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6">
                                <div class="form-group">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\GYM\resources\views/admin/measurement/edit.blade.php ENDPATH**/ ?>