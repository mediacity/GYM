...
<?php $__env->startSection('title',__('Add Attendance')); ?>
<?php $__env->startSection('breadcum'); ?>
<div class="breadcrumbbar breadcrumbbar-one">
    <div class="row align-items-center">
        <div class="col-lg-4 col-md-7">
            <h4 class="page-title"><?php echo e(__("Attendance")); ?></h4>
            <div class="breadcrumb-list">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">
                        <?php echo e(__('Add Member Attendance')); ?>
        ...
        <div class="col-lg-8 col-md-5">
            <div class="top-btn-block text-right">
                ...
                <?php echo e(__(" Staff Aattendance")); ?><i class="feather icon-arrow-right ml-2"></i></a>
                <a href="<?php echo e(route('memberattendance.index')); ?>" class="btn btn-primary-rgba mr-2"><i
...
<!-- Start Form -->
<form autocomplete="off" class="form-light form" action="<?php echo e(route('memberattendance.store')); ?>" novalidate method="POST">
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h1 class="card-title"><?php echo e(__('Your Attendance Details:')); ?></h1>
                </div>
                <br>
                <!--name-->
                <div class="col-md-12">
                    <div class="row">
                        <div class="col-lg-4 col-md-6">
                            <div class="form-group">
                                <label class="text-dark"><?php echo e(__
                            ...
                            <div class="form-group member-attendance-slider">
                                ...
                                <label class="switch"><input type="checkbox" id="togBtn" name="attend">
                                    <div class="slider round">
                                        <!--ADDED HTML -->
                                        <span class="on"><?php echo e(__("Present")); ?></span><span class="off"><?php echo e(__("Absent")); ?></span>
                                        <!--END-->
                                    </div>
                                </label>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\GYM\resources\views/admin/memberattendance/create.blade.php ENDPATH**/ ?>