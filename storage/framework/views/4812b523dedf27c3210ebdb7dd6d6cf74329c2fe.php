...
<div class="breadcrumbbar breadcrumbbar-one">
    <div class="row align-items-center">
        <div class="col-lg-4 col-md-8">
            <h4 class="page-title"><?php echo e(__("Trainer")); ?></h4>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <label class="text-dark" for="address"><?php echo e(__("Pincode:")); ?> <span
                                            class="text-danger">*</span></label>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <small class="text-muted text-info"><i class="text-dark feather icon-help-circle"></i> <?php echo e(__("Enter your Country")); ?>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <small class="text-muted text-info"><i class="text-dark feather icon-help-circle"></i> <?php echo e(__("Enter your State")); ?>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <small class="text-muted text-info"> <i
                                                class="text-dark feather icon-help-circle"></i> <?php echo e(__("Enter your City")); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <label class="text-dark"><?php echo e(__("Select Image:")); ?> <span class="text-danger">*</span></label>
                                    <div class="input-group">
                                    ...
                                    <?php if(isset($trainer->photo)): ?>
                                        <img src="<?php echo e(url('/assets/images/users/' .$trainer->photo)); ?>"
                                        class="img-fluid ">
                                    <?php endif; ?>
                                    <small class="text-muted text-info"> <i
                                        class="text-dark feather icon-help-circle"></i> <?php echo e(__("Please select your image")); ?>
                                        ...
                                        <div class="form-group<?php echo e($errors->has('is_active') ? ' has-error' : ''); ?> switch-main-block">
                                            <div class="custom-switch">
                                                ...
                                                <label class="custom-control-label"
                                                    for="switch1"><span><?php echo e(__("Status")); ?></span></label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\GYM\resources\views/admin/trainerlist/trainer/create.blade.php ENDPATH**/ ?>