...
<!-- <script src="<?php echo e(url('assets/js/star-rating.min.js')); ?>"></script> -->
<script src="<?php echo e(url('assets/plugins/jquery-bar-rating/jquery.barrating.min.js')); ?>"></script>
<!-- <script src="<?php echo e(url('assets/js/bs-custom-file-input.js')); ?>"></script> -->
<!-- <script src="<?php echo e(url('assets/js/bs-custom-file-input.min.js')); ?>"></script> -->
<!-- <script src="<?php echo e(url('assets/js/custom-file-input.js')); ?>"></script> -->
<script>
...
<?php echo $__env->yieldContent('script'); ?><?php /**PATH C:\xampp\htdocs\GYM\gym_new\resources\views/layouts/scripts.blade.php ENDPATH**/ ?>