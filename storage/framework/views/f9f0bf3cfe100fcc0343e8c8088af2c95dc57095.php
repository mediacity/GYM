...
<?php $__env->startSection('title',__('All ExerciseName')); ?>
<?php $__env->startSection('maincontent'); ?>
<!-- Start Breadcrumbbar -->                    
<?php $__env->startComponent('components.breadcumb',['secondaryactive' => 'active']); ?>
<?php $__env->slot('heading'); ?>
<?php echo e(__('ExerciseName')); ?>
...
<div class="col-md-12 col-lg-6 text-right">
  <div class="top-btn-block">
    <a href="<?php echo e(route('exercisename.create')); ?>" class=" btn btn-primary-rgba mr-2"><i
        class="feather icon-plus mr-2"></i><?php echo e(__("Add Exercisename")); ?></a>
    ...
    <a href="<?php echo e(route('exn.index')); ?>" class="btn btn-primary-rgba mr-2"><i
    ...
    <div class="card m-b-30">
      <div class="card-header">
        <div class="row align-items-center">
          <div class="col-6">
            <h5 class="card-title mb-0"><?php echo e(__("All ExerciseName")); ?></h5>
          </div>
          ...
          <table id="datatable-buttons" class="table table-border">
            <thead>
              <tr>
                ...
                <th>
                  #</th>
                <th><?php echo e(__("ExerciseName")); ?></th>
                <th><?php echo e(__("Body Part")); ?></th>
                <th><?php echo e(__("Exercise Type")); ?></th>
            ...
            <tbody>
              <?php $__currentLoopData = $exercisename; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <tr>
                 <td>
                  <div class='inline'>
                    ...
                    <div class="modal-dialog modal-sm">
                      ...
                      <div class="modal-content">
                        ...
                        <div class="modal-footer">
                          <form id="bulk_delete_form" method="post" action="<?php echo e(route('exercisename.bulk_delete')); ?>">
                            <?php echo csrf_field(); ?>
                ...
                <td><?php echo e($list->exercisename); ?></td>
                <td><?php echo e($list->body_part); ?></td>
                <td> <?php if($list->type): ?>
                  <?php $__currentLoopData = $list->type; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <?php
                  $type = App\Type::find($t);
                  ?>
                  <?php if(isset($type)): ?>
                  <span class="badge badge-primary"><?php echo e(ucfirst($type->name)); ?></span>
                  <?php endif; ?>
                ...
                Admin' ): ?>
                <td>
                  <?php echo Form::open(['method' => 'PUT', 'route' => ['exercisename.status', $list->id]]); ?>
                ...
                <td>
                  <div class="button-list">
                    <a href="<?php echo e(route('exercisename.edit', $list->id)); ?>" class="btn btn-xm btn-success-rgba"><i
                    ...
                    <div id="deleteModal<?php echo e($list->id); ?>" class="delete-modal modal fade" role="dialog">
                      <div class="modal-dialog modal-sm">
                        ...
                        <div class="modal-content">
                          ...
                          <div class="modal-footer">
                            <?php echo Form::open(['method' => 'DELETE', 'route' => ['exercisename.destroy', $list->id]]); ?>

                            <button type="reset" class="btn btn-primary-rgba" data-dismiss="modal"><?php echo e(__("No")); ?></button>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\GYM\gym_new\resources\views/admin/exercisename/index.blade.php ENDPATH**/ ?>