...
<?php $__env->startSection('title',__('All Fees')); ?>
...
<div class="col-md-12 col-lg-6 text-right">
    <div class="top-btn-block">
        <a href="<?php echo e(route('fees.create')); ?>" class="btn btn-primary-rgba mr-2"><i class="feather icon-plus mr-2"></i><?php echo e(__("Add
        Fees")); ?></a>
        ...
        <a href="<?php echo e(route('fee.index')); ?>" class="btn btn-primary-rgba mr-2"><i
        ...
        <div class="card m-b-30">
            <div class="card-header">
                <div class="row align-items-center">
                    <div class="col-6">
                        <h5 class="card-title mb-0"><?php echo e(__("All Fees")); ?></h5>
                    </div>
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table id="datatable-buttons" class="table table-border">
                        ...
                        <?php if(isset($feeslist)): ?>
                        <tbody>
                            <?php $__currentLoopData = $feeslist; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td>
                                    <div class='inline'>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <form id="bulk_delete_form" method="post"
                                                        action="<?php echo e(route('fees.bulk_delete')); ?>">
                                                        <?php echo csrf_field(); ?>
                                ...
                                <td><?php echo e('$'.(ucfirst($list->price))); ?> </td>
                                <td>
                                ...
                                Auth::user()->roles->first()->name == 'Super Admin' ): ?>
                                <td>
                                    <?php echo Form::open(['method' => 'PUT', 'route' => ['fees.status', $list->id]]); ?>
                                ...
                                <td>
                                    <div class="button-list">
                                        <a href="<?php echo e(route('fees.edit', $list->id)); ?>"
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\GYM\gym_new\resources\views/admin/fees/index.blade.php ENDPATH**/ ?>