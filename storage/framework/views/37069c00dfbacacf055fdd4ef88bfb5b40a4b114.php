...
<head>
    ...
    <title><?php echo e(__('500 | Internal Server Error')); ?></title>
    <!-- Fevicon -->
                 ...
                 <div class="row no-gutters align-items-center justify-content-center">
                    ...
                    <div class="col-md-8 col-lg-6">
                        <div class="text-center">
                            ...
                            <img src="<?php echo e(url('assets/images/error/internal-server.svg')); ?>" class="img-fluid error-image" alt="500">
                            <h4 class="error-subtitle mb-4"><?php echo e(__('500 Internal Server Error')); ?></h4>
                            <p class="mb-4"><?php echo e(__('The server encountered an internal error or misconfiguration and was unable to complete your request.')); ?></p>                           
...
<?php /**PATH C:\xampp\htdocs\GYM\gym_new\resources\views/errors/500.blade.php ENDPATH**/ ?>