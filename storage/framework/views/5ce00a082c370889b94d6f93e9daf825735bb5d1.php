...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <input type="file" name="file" value="<?php echo e($user->file); ?>" id="file2" class="<?php echo e($errors->has('file') ? ' is-invalid' : ''); ?> inputfile inputfile-1" />
                            <label for="file2">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\GYM\resources\views/manage/users/edit.blade.php ENDPATH**/ ?>