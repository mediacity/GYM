...
<?php $__env->startSection('title',__('All Groups')); ?>
    ...
    <div class="row align-items-center">
        ...
        <div class="col-lg-8 col-md-7">
            <div class="top-btn-block text-right">
                <a href="<?php echo e(route('group.create')); ?>" class="btn btn-primary-rgba mr-2"><i
                class="feather icon-plus mr-2"></i><?php echo e(__("Add Group")); ?></a>
        ...
        <div class="col-lg-12">
            <div class="card m-b-30">
                <div class="card-header">
                    <div class="row align-items-center">
                        <div class="col-6">
                            <h5 class="card-title mb-0"><?php echo e(__("All Group")); ?></h5>
                        </div>
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="datatable-buttons" class="table table-border">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $grouplist; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                            <td>
                            <div class='inline'>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            <form id="bulk_delete_form" method="post"
                                                action="<?php echo e(route('group.bulk_delete')); ?>">
                                                <?php echo csrf_field(); ?>
                        ...
                        <td>
                                    ...
                                    <td><?php echo e(str_limit($list->detail,'50')); ?></td>
                                    <td>
                                        <?php if(isset($list->user_id)): ?>
                                        <?php $__currentLoopData = $list->user_id; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $uid): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php
                                        $user = App\User::find($uid);
                                        ?>
                                        <?php if(isset($user)): ?>
                                        <span class="badge badge-primary"><?php echo e(ucfirst($user->name)); ?></span>
                                        <?php endif; ?>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        <?php endif; ?>
                                    </td>
                                    <td>
                                        <?php echo Form::open(['method' => 'PUT', 'route' => ['group.status', $list->id]]); ?>
                                    ...
                                    <td>
                                        <div class="button-list">
                                            <a href="<?php echo e(route('group.edit', $list->id)); ?>"
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\GYM\resources\views/admin/group/index.blade.php ENDPATH**/ ?>