                         ...
                         <span><?php echo e(__('User')); ?></span>
                          ...
                          <li class="<?php echo e(Nav::isResource('users')); ?> <?php echo e(Nav::isResource('roles')); ?>">
                            ...
                            <ul class="vertical-submenu">
                                ...
                                <li>
                                    <a class="<?php echo e(Nav::isResource('users')); ?>" href="<?php echo e(route('users.index')); ?>"><?php echo e(__('All users')); ?></a>
                                </li>
                                <?php endif; ?>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('roles.view')): ?>
                                <li>
                                    <a class="<?php echo e(Nav::isResource('roles')); ?>" href="<?php echo e(route('roles.index')); ?>"><?php echo e(__('Roles & Permissions')); ?></a>
                                </li>
                                <?php endif; ?>
                                <li>
                                    <a class="nav-link" href="<?php echo e(route('user.affiliate.settings')); ?>"> <?php echo e(__('Referal Link')); ?> </a>
                                </li>
                                <li>
                                    <a class="<?php echo e(Nav::isResource('quotation')); ?>" href="<?php echo e(route('quotation.index')); ?>"><?php echo e(__('Quotation')); ?></a>
                                </li>
                            </ul>
                        </li>
                        <!-- Gym Management -->
                        ...
                        <li class="<?php echo e(Nav::isResource('exercise')); ?> <?php echo e(Nav::isResource('measurement')); ?>  <?php echo e(Nav::isResource('locker')); ?>  ">
                            ...
                            <ul class="vertical-submenu">
                                ...
                                <li class="<?php echo e(Nav::isResource('exercisename')); ?> <?php echo e(Nav::isResource('type')); ?>">
                                    ...
                                    <ul class="vertical-submenu">
                                          <li>
                                            <a class="<?php echo e(Nav::isResource('exercisename')); ?>" href="<?php echo e(route('exercisename.index')); ?>"><?php echo e(__('Exercisename ')); ?></a>
                                        </li>
                                         <li>
                                            <a class="<?php echo e(Nav::isResource('type')); ?>" href="<?php echo e(route('type.index')); ?>"><?php echo e(__('Type')); ?></a>
                                        </li>
                                    </ul>
                                </li>
                                <?php endif; ?>
                                ...
                                <li class="<?php echo e(Nav::isResource('packages')); ?> <?php echo e(Nav::isResource('fees')); ?>">
                                    ...
                                    <ul class="vertical-submenu">
                                        ...
                                        <li>
                                            <a class="<?php echo e(Nav::isResource('packages')); ?>" href="<?php echo e(route('packages.index')); ?>">
                                ...
                                <li>
                                    <a class="<?php echo e(Nav::isResource('admin/supplement')); ?>" href="<?php echo e(route('supplement.index')); ?>">
                                ...
                                <li class="<?php echo e(Nav::isResource('diet_session')); ?> <?php echo e(Nav::isResource('diet_content')); ?>">
                                    ...
                                    <ul class="vertical-submenu">
                                        ...
                                        <li>
                                            <a class="<?php echo e(Nav::isResource('diet')); ?>" href="<?php echo e(route('diet.index')); ?>"><?php echo e(__('Diet Package')); ?></a>
                                        </li>
                                        <?php endif; ?>
...
<!-- End Sidebar --><?php /**PATH D:\Official Projects\Media City\GYM\GYM\resources\views/layouts/sidebar.blade.php ENDPATH**/ ?>