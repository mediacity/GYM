...
<?php $__env->startSection('title',__('Edit Service :eid -',['eid' => $service->name])); ?>
    ...
    <div class="col-lg-12">
        <div class="card m-b-30">
            <div class="card-header">
                <div class="row align-items-center">
                    <div class="col-12">
                        <h5 class="card-title mb-0"><?php echo e(__("Edit Service")); ?></h5>
                    </div>
                </div>
            </div>
            <div class="card-body">
                <div class="admin-form">
                    <?php echo Form::model($service, ['method' => 'PATCH', 'route' => ['service.update', $service->id],
                    'files' =>
                        ...
                        <div class="col-lg-12 col-md-12">
                            <div
                                ...
                                <div class="custom-switch">
                                    <?php echo Form::checkbox('is_active', 1,$service->is_active==1 ? 1 : 0, ['id' =>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\GYM\resources\views/admin/service/edit.blade.php ENDPATH**/ ?>