...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea name="login_description" cols="30" rows="1" type="text" class="form-control" placeholder="<?php echo e(__("enter your description")); ?>"><?php echo e($setting ? $setting->login_description : ""); ?></textarea>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6">
                                <div class="form-group">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\GYM\resources\views/admin/settings/settings.blade.php ENDPATH**/ ?>