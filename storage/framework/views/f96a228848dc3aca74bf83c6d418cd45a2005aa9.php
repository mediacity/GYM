...
<?php $__env->startSection('title',__('All Service')); ?>
    ...
    <div class="row align-items-center">
        ...
        <div class="col-lg-8 col-md-7">
            <div class="top-btn-block text-right">
                ...
                <a href="<?php echo e(route('service.create')); ?>" class="btn btn-primary-rgba mr-2"><i
                        class="feather icon-plus mr-2"></i><?php echo e(__("Add Service")); ?></a>
                ...
                <a href="<?php echo e(route('ser.index')); ?>" class="btn btn-success-rgba mr-2"><i
    ...
    <div class="col-lg-12">
        <div class="card m-b-30">
            <div class="card-header">
                <div class="row align-items-center">
                    <div class="col-6">
                        <h5 class="card-title mb-0"><?php echo e(__("All Service")); ?></h5>
                    </div>
                </div>
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <table id="datatable-buttons" class="table table-border">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $service; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td>
                                    <div class='inline'>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <form id="bulk_delete_form" method="post"
                                                        action="<?php echo e(route('service.bulk_delete')); ?>">
                                                        <?php echo csrf_field(); ?>
                                ...
                                <td><span class="badge badge-primary"><?php echo e('$'.(ucfirst($list->price))); ?> </span></td>
                                <td>
                                    <?php echo Form::open(['method' => 'PUT', 'route' => ['service.status', $list->id]]); ?>
                                ...
                                <td>
                                    <div class="button-list">
                                        <a href="<?php echo e(route('service.edit', $list->id)); ?>"
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\GYM\resources\views/admin/service/index.blade.php ENDPATH**/ ?>