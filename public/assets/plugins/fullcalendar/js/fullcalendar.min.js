...
!(function (a) {
    ...
    function Qa(c, e) {
        ...
        function q() {
            $ =
                "number" == typeof T.options.contentHeight
                    ...
                    ? T.options.height - (V.el ? V.el.outerHeight(!0) : 0)
                    : Math.round(W.width() / Math.max(T.options.aspectRatio, 0.5));
        }
        function r(a) {
        ...
        function M() {
            W.css({ width: "100%", height: W.height(), overflow: "hidden" });
        }
        function N() {
            W.css({ width: "", height: "", overflow: "" });
        }
        function O() {
            return T;
        }
        ...
        T.bindOptions(["lang", "monthNames", "monthNamesShort", "dayNames", "dayNamesShort", "firstDay", "weekNumberCalculation"], function (a, b, c, d, e, g, h) {
            ...
            (T.moment = function () {
                var a;
                return (
                    "local" === T.options.timezone
                        ? ((a = Wa.moment.apply(null, arguments)), a.hasTime() && a.local())
                        : (a = "UTC" === T.options.timezone ? Wa.moment.utc.apply(null, arguments) : Wa.moment.parseZone.apply(null, arguments)),
                    f(a),
                    a
                );
            }),
        ...
        var V,
            ...
            ga = 0,
            ha = [];
        (aa = null != T.options.defaultDate ? T.moment(T.options.defaultDate).stripZone() : T.getNow()),
    ...
    function Ua() {
        ...
        function f(b, c) {
            i(b, function (d) {
                ...
                if (c === b._fetchId && "rejected" !== b._status) {
                    if (((b._status = "resolved"), d)) for (e = 0; e < d.length; e++) (f = d[e]), (g = i ? f : C(f, b)), g && da.push.apply(da, G(g));
                    h();
                }
            });
        }
        ...
        function i(b, c) {
            ...
            if (g)
                a.isFunction(g)
                    ? (U.pushLoading(),
                      g.call(U, W.clone(), X.clone(), U.options.timezone, function (a) {
                          c(a), U.popLoading();
                      }))
                    : a.isArray(g)
                    ? c(g)
        ...
        function r(b) {
            var c, d;
            for (c = 0; c < $.length; c++) if (((d = $[c]), d === b)) return [d];
            return (
                (d = p(b)),
                d
                    ? [d]
        ...
        function C(c, d) {
            var e,
                ...
                h = {};
            if (
                (U.options.eventDataTransform && (c = U.options.eventDataTransform(c)),
        ...
        function F(a) {
            null == a.allDay && (a.allDay = !(a.start() || (a.end && a.end.hasTime()))),
                a.allDay ? (a.start.stripTime(), a.end && a.end.stripTime()) : (a.start.hasTime() || (a.start = U.applyTimezone(a.start.time(0))), a.end && !a.end.hasTime() && (a.end = U.applyTimezone(a.end.time(0))));
        }
        function G(b, c, d) {
            var e,
                f,
        ...
        function H(b, c, d) {
            ...
            return (
                ...
                E(c),
                (f = { start: b._start.clone(), end: b._end ? b._end.clone() : U.getDefaultEventEnd(b._allDay, b._start), allDay: c.allDay }),
                E(f),
            ...
            return (
                ...
                a.each(b, function (b, j) {
                    ...
                    (k = { start: j.start.clone(), end: j.end ? j.end.clone() : null, allDay: j.allDay }),
                        ...
                        E(l),
                        c ? (l.end = null) : f && !l.end && (l.end = U.getDefaultEventEnd(l.allDay, l.start)),
        ...
        function J(b) {
            var c,
                ...
                e = { className: "fc-nonbusiness", start: "09:00", end: "17:00", dow: [1, 2, 3, 4, 5], rendering: "inverse-background" },
                f = U.getView();
    ...
    var Wa = (a.fullCalendar = { version: "2.9.0", internalApiVersion: 4 }),
        Xa = (Wa.views = {});
        ...
        buildSegDragListener: function (a) {
            ...
            var l = (this.segDragListener = new rb(f, {
                ...
                interactionStart: function (d) {
                    (b = !1), (c = new sb(a.el, { additionalClass: "fc-dragging", parentEl: f.el, opacity: l.isTouch ? null : f.opt("dragOpacity"), revertDuration: f.opt("dragRevertDuration"), zIndex: 2 })), c.hide(), c.start(d);
                },
    ...
    var wb = (Wa.TimeGrid = tb.extend(ub, {
        ...
        computeLabelInterval: function (a) {
            var c, d, e;
            for (c = Nb.length - 1; c >= 0; c--) if (((d = b.duration(Nb[c])), (e = R(d, a)), ha(e) && e > 1)) return d;
            return b.duration(a);
        },
        computeEventTimeFormat: function () {
    ...
    (Xa.basic = { class: Gb }), (Xa.basicDay = { type: "basic", duration: { days: 1 } }), (Xa.basicWeek = { type: "basic", duration: { weeks: 1 } }), (Xa.month = { class: Ib, duration: { months: 1 }, defaults: { fixedWeekCount: !0 } });
    var Jb = (Wa.AgendaView = xb.extend({
        ...
        Mb = 5,
        Nb = [{ hours: 1 }, { minutes: 30 }, { minutes: 15 }, { seconds: 30 }, { seconds: 15 }];
    return (
        (Xa.agenda = { class: Jb, defaults: { allDaySlot: !0, allDayText: "all-day", slotDuration: "00:30:00", minTime: "00:00:00", maxTime: "24:00:00", slotEventOverlap: !0 } }),
