...
$(document).ready(function() {
    ...
    var options = {
        ...
        colors: ['#FF6600', '#43d187','#f7bb4d', '#f2f3f7'],
        series: [44, 55, 67, 83],
   ...
   var chart = new ApexCharts(
    ...
    colors: ['#FF6600', '#43d187', '#f7bb4d', '#96a3b6'],
    labels: ['Superadmin', 'Admin', 'User', 'Trainer'],
    legend: {
      show: true,
      floating: true,
      fontSize: '16px',
